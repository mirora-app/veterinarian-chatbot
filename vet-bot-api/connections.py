...
def build_prompt(user_message, pricing_data):
    ...
    system_prompt = (
        ...
        "**Context**\n"
        "Answer questions using the pricing and service information provided below, when possible.\n\n"
        "**Constraints**\n"
        "**NEVER use prior knowledge of Goodknight Mobile Vet.**\n"
        "**Do not make up services, discounts, or policies. Do not guess.**\n"
        "**Do not recommend medical treatments or medications unless explicitly listed in the Pricing and Service Information.**\n"
